            ...
            <div class="card card-body mb-4">
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <p>***بالنسبة للربح قبل الزكاة EBIT  سيكون في السنة الأولى ({{$calc_total['net_profit_first_year_as_string']}}) وفي السنة الثانية ({{$calc_total['second_year_profit_before_zakat']}}) وفي السنة الثالثة  ({{$calc_total['third_year_profit_before_zakat']}}).</p>
                        ...
                        <p>***بالنسبة لقائمة التدفقات النقدية من الأنشطة التشغيلية فصافي الربح في السنة الأولى ( {{ $first_year_net_cash_flow }}) وفي السنة الثانية ( {{ $second_year_net_cash_flow}}) وفي السنة الثالثة ( {{ $third_year_net_cash_flow }}) .</p>
                        ...
                        <p>***و إجمالي التكاليف قيمته في السنة الأولى ( {{$calc_total['invest_total_cost_first_year_as_string'] }}) وفي السنة الثانية ( {{ $calc_total['invest_total_cost_second_year_as_string'] }}) وفي السنة الثالثة فقيمته ( {{ $calc_total['invest_total_cost_third_year_as_string']}})</p>
