            ...
            <div class="card card-body mb-4">
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <p>***و إجمالي التكاليف قيمته في السنة الأولى ( {{$calc_total['total_cost_first_year_as_string'] }}) وفي السنة الثانية ( {{ $calc_total['total_cost_second_year_as_string'] }}) وفي السنة الثالثة فقيمته ( {{ $calc_total['total_cost_third_year_as_string']}})</p>
