...
@section('content')
    <div class=" row mt-1 d-print-none">
        ...
        <div class="col text-end">
            <a href="/design-business-model"
                class="btn btn-info btn-sm  add_event waves-effect waves-light">{{ __('Design Business Model') }}</a>
                ...
                <table class="table align-items-center mb-0 table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan=""><label>{{ __('Revenue Stream') }}</label>
