    ...
    <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge mb-3">
                            ...
                            <input type="text" name="company_name" class="form-control form-control-lg"
                                id="searchJobCareers" placeholder="{{ __('Search Buisness Model') }}"
        ...
        <div class="col-12">
                       ...
                       <div class="card-body">
                           <div class="row ">
                               <div class="col-md-9">
                                   ...
                                   <p class="text-sm">{{ __('Related Product') }}:<span class="text-dark fw-bolder">
                                   ...
                                   <p class="text-sm">{{ __('Designed By') }}:<span class="text-purple fw-bolder">
                                           @if (isset($users[$model->admin_id]))
                                               {{ $users[$model->admin_id]->first_name }}
                                               {{ $users[$model->admin_id]->last_name }}
                                           @endif
                                       </span></p>
                                   <p class="text-sm">{{ __('Created At') }}:
                                       <span class="badge bg-info">
                                           {{ \App\Supports\DateSupport::parse($model->updated_at)->format(config('app.date_format')) }}</span>
                                   </p>
                               </div>
           ...
           @endforeach 
                @else
                <div class="col-12">
                    <h4 class="text-secondary fw-bolder text-center">
                        {{ __('No Models Found') }}
                    </h4>
                </div>
                @endif
