                        ...
                        <div class="col align-self-end">
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="summary" name="summary">
@if (!empty($model)){{ $model->summary }} @else {{old('summary')}} @endif
</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="description" name="description">
@if (!empty($model)){{ $model->description }} @else {{old('description')}} @endif
</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="team" name="team">
@if (!empty($model)){{ $model->team }} @else {{old('team')}} @endif
</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="business_initiatives" name="business_initiatives">
@if (!empty($model)){{ $model->business_initiatives }} @else {{old('business_initiatives')}} @endif
</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="target_market" name="target_market">
@if (!empty($model)){{ $model->target_market }} @else {{old('target_market')}} @endif
</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="budget" name="budget">
                                                @if (!empty($model)){{ $model->budget }} @else {{old('budget')}} @endif
                                            </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="marketing" name="marketing_channels">
                                                @if (!empty($model)){{ $model->marketing_channels }} @else {{old('marketing_channels')}} @endif
                                            </textarea>
                                    </div>
                                </div>
                            </div>
