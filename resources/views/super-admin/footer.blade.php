...
@section('content')
    ...
    <div class="btn-group">
        <button type="button" class="btn ms-auto btn-dark btn-icon-only " data-bs-toggle="offcanvas" data-bs-target="#footer"
            aria-controls="offcanvasRight">
            <span class="btn-inner--icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class=" mb-2 feather feather-edit">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
            </span>
        </button>
        <a href="/#footer" target="_blank" type="button" class="btn btn-success btn-icon-only">
            <span class="btn-inner--icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <form action="/save-footer-section" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="subtitle" class="form-control" id="subtitle"
                        value="{{ $contact->subtitle ?? (old('subtitle') ?? '') }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="email" type="email" class="multisteps-form__input form-control"
