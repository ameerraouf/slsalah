                    ...
                    <form action="/save-subscription-plan" method="post">
                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                ...
                                <input class="form-control datetimepicker" name="price_yearly" type="number" min="0" disabled
                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 px-0">
                                <div class="form-check form-switch ps-0">
                                    <input class="form-check-input ms-auto" type="checkbox" id="module_all"
                                           name="module_all" value="1"
                                           @if(count($available_modules) == count(isset($plan_modules) ? $plan_modules : [])) checked @endif
                                    >
                            ...
                            @foreach($module['modules'] as $key2 =>$item)
                                    <li class="list-group-item border-0 px-0">
                                        <div class="form-check form-switch ps-0">
                                            <input class="form-check-input ms-auto model-input" type="checkbox" id="module_{{$key}}"
                                                   name="modules[{{ $key2 }}]"
...
{{--                                </div>--}}
                        ...
                        <div class="form-check form-switch ps-0">
                            <input class="form-check-input ms-auto" type="checkbox" id="active"
                                   name="active" value="1"
                                   @if($plan && !$plan->active) checked @endif
                            >
                            <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0"
