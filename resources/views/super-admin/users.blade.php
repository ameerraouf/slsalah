                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                        ...
                                                        @if (empty($workspace_user['photo']))
                                                            <div
                                                                ...
                                                                <h6 class="text-uppercase text-purple ">
                                                                    {{ $workspace_user->first_name['0'] }}{{ $workspace_user->last_name['0'] }}
                                                                </h6>
                                                            </div>
                                                        @else
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center px-3">
                                                        <h6 class="mb-0 text-sm">{{ $workspace_user->first_name }}
                                                            {{ $workspace_user->last_name }}</h6>
                                                        <p class="text-xs text-secondary mb-0">{{ $workspace_user->email }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">
                                                    {{ \App\Supports\DateSupport::parse($workspace_user->created_at)->format(config('app.date_time_format')) }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
                                                <div class="ms-auto text-end">
                                                    <a class="btn btn-link text-dark px-3 mb-0"
                                                        href="/user-edit/{{ $workspace_user->id }}"><i
