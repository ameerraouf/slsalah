                ...
                <thead>
                    <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                            {{ __('Product Name') }}</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">{{ __('Members') }}
                        </th>
                        ...
                        <tr>
                                            ...
                                            @if (isset($users[$member]))
                                                ...
                                                @else
                                                    <div class="avatar avatar-sm  rounded-circle bg-success-light">
                                                        <p class="mt-3 text-success text-uppercase">
                                                            <span>{{ $users[$member]->first_name[0] }}{{ $users[$member]->last_name[0] }}</span>
                                                        </p>
                                                    </div>
                                                @endif
                                            @endif
                            ...
                            <td>
                                <span class="badge badge-dot me-4">
                                    <i class="bg-info"></i>
                                    <span
                                        class="badge bg-{{ ['Pending' => 'info', 'Started' => 'success', 'Finished' => 'primary'][$project->status] }}">{{ __($project->status) }}</span>
                                </span>
                            </td>
