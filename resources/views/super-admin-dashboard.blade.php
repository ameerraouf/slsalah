            ...
            <div class="card bg-info">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm text-white mb-0 text-capitalize font-weight-bold">{{ __(' Total Users') }}
                                </p>
            ...
            <div class="card bg-dark">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm text-white mb-0 text-capitalize font-weight-bold">{{ __('Total Plans') }}
                                </p>
                                <h5 class="font-weight-bolder text-white mt-4 ">
                                    {{ $total_plans }}
                                </h5>
                                                ...
                                                <div>
                                                    @if (empty($skit_user['photo']))
                                                        <div
                                                            ...
                                                            <h6 class="text-uppercase text-purple ">
                                                                {{ $skit_user->first_name['0'] }}{{ $skit_user->last_name['0'] }}
                                                            </h6>
                                                        </div>
                                                    @else
                                                        <img src="{{ PUBLIC_DIR }}/uploads/{{ $skit_user->photo }}"
                                                            alt="" class="avatar avatar-md">
                                                    @endif
                                                </div>
                                                <div class="d-flex flex-column justify-content-center px-3">
                                                    <h6 class="mb-0 text-sm">{{ $skit_user->first_name }}
                                                        {{ $skit_user->last_name }}</h6>
