...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="font-weight-bolder">{{ __('Porter Five Forces Model') }}</h4>
                    <p>{{ __('The Porter Five Forces Model is a framework for analyzing a companycompetitive environment.') }}
                    </p>
                    <hr>
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="structure" name="entrants">
@if (!empty($model))
{{ $model->entrants }}
@else
{{ old('entrants') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="strategy" name="rivals">
@if (!empty($model))
{{ $model->rivals }}
@else
{{ old('rivals') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="system" name="suppliers">
@if (!empty($model))
{{ $model->suppliers }}
@else
{{ old('suppliers') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="style" name="customers">
@if (!empty($model))
{{ $model->customers }}
@else
{{ old('customers') }}
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-12 align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="shared" name="substitute">
@if (!empty($model))
{{ $model->substitute }}
@else
{{ old('substitute') }}
