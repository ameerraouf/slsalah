                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="strengths" name="strengths">
@if (!empty($model))
{{ $model->strengths }}
@else
{{ old('strengths') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="weaknesses" name="weaknesses">
@if (!empty($model))
{{ $model->weaknesses }}
@else
{{ old('weaknesses') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="opportunities" name="opportunities">
@if (!empty($model))
{{ $model->opportunities }}
@else
{{ old('opportunities') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="threats" name="threats">
@if (!empty($model))
{{ $model->threats }}
@else
{{ old('threats') }}
