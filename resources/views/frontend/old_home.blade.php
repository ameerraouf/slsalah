                ...
                <div class="row">
                    ...
                    <div  data-aos="fade-down"
                        ...
                        <div class=" text-start buttons">
                            <a href="/signup" type="button" class="btn rounded bg-info text-white mt-4">{{__('Get Started')}}</a>
