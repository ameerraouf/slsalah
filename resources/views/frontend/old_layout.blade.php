<!DOCTYPE html>
<html lang="en" itemscope itemtype="http://schema.org/WebPage" dir="rtl">
...
<span class="navbar-toggler-bar bar3"></span>
        ...
        <div class="collapse  navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 " id="navigation">
            <ul class="navbar-nav bg-transparent navbar-nav-hover w-100 align-items-center">
                ...
                <li class="nav-item float-end ms-5 ms-lg-auto">
                    <a class="fw-bolder h6 ps-2 d-flex justify-content-between cursor-pointer align-items-center mb-0 me-5" href="/login" target="_blank">
                ...
                <li class="nav-item my-auto ms-3 ms-lg-0">
                    <a href="/signup" class="btn bg-info text-white mb-0 me-1 mt-2 mt-md-0">{{__('Sign Up for free')}}</a>
                </li>
            </ul>
        </div>
    </div>
