            ...
            @if(empty($modules) || in_array('planning_revenue_operating_assumptions',$modules))
                <li class="nav-item ">
                    <a class="nav-link @if(($selected_navigation ?? '') === 'planning_revenue_operating_assumptions') active @endif " href="/planning_revenue_operating_assumptions">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="20" height="20" x="0" y="20" viewBox="0 0 40 40" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><g fill="white" fill-rule="nonzero"><path d="M27 34.5a1 1 0 0 0 2 0c0-3.308-3.06-6.042-7-6.444V27a1 1 0 0 0-2 0v1.056c-3.94.4-7 3.136-7 6.444s3.06 6.042 7 6.444v8.988c-2.833-.358-5-2.207-5-4.432a1 1 0 0 0-2 0c0 3.308 3.06 6.042 7 6.444V53a1 1 0 0 0 2 0v-1.056c3.94-.4 7-3.136 7-6.444s-3.06-6.042-7-6.444v-8.988c2.833.358 5 2.207 5 4.432zm-12 0c0-2.225 2.167-4.074 5-4.432v8.864c-2.833-.358-5-2.207-5-4.432zm12 11c0 2.225-2.167 4.074-5 4.432v-8.864c2.833.358 5 2.207 5 4.432z" fill="white" data-original="#000000" class=""></path><path d="M3.6 30.173a1 1 0 0 0-1.328.486A24.4 24.4 0 0 0 0 41c0 12.607 7.065 19 21 19 2.816.044 5.625-.28 8.357-.963a1 1 0 0 0-.514-1.933A30.832 30.832 0 0 1 21 58C8.215 58 2 52.439 2 41a22.114 22.114 0 0 1 2.087-9.5 1 1 0 0 0-.487-1.327zM57 25H35a3 3 0 0 0-3 3v29a3 3 0 0 0 3 3h22a3 3 0 0 0 3-3V28a3 3 0 0 0-3-3zm1 32a1 1 0 0 1-1 1H35a1 1 0 0 1-1-1V28a1 1 0 0 1 1-1h22a1 1 0 0 1 1 1z" fill="white" data-original="#000000" class=""></path><path d="M39 38h14a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2H39a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2zm0-6h14v4H39zM41 41h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM41 45h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM41 49h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM41 53h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM48 41h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM48 45h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM48 49h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM48 53h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM55 41h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM55 45h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM55 49h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM55 53h-3a1 1 0 0 0 0 2h3a1 1 0 0 0 0-2zM6.325 1.263C3.692 3.675 8.318 11.115 11.044 15H10.5a3.482 3.482 0 0 0-2.477 1.022A3.525 3.525 0 0 0 7 18.5a3.489 3.489 0 0 0 1.754 3.015A47.1 47.1 0 0 0 5.46 25.4a1 1 0 0 0 1.6 1.2 48.325 48.325 0 0 1 4-4.6H31.5a3.5 3.5 0 1 0 0-7h-.544c2.725-3.885 7.351-11.324 4.72-13.737-1.21-1.108-2.62-.3-3.863.407A7.713 7.713 0 0 1 28 3a3.874 3.874 0 0 1-2.851-1.26 5.821 5.821 0 0 0-8.3 0A3.874 3.874 0 0 1 13.993 3a7.681 7.681 0 0 1-3.81-1.33C8.941.961 7.532.156 6.325 1.263zm26.238 16.175A1.5 1.5 0 0 1 31.5 20h-21a1.5 1.5 0 0 1 0-3h21c.398 0 .78.158 1.063.438zM13.993 5a5.821 5.821 0 0 0 4.151-1.741 3.854 3.854 0 0 1 5.7 0A5.825 5.825 0 0 0 28 5a9.581 9.581 0 0 0 4.809-1.594c.457-.322.973-.55 1.519-.669 1.026.94-1.686 6.609-5.832 12.263H26v-5a1 1 0 0 0-2 0v5h-6v-5a1 1 0 0 0-2 0v5h-2.492C9.362 9.346 6.65 3.677 7.69 2.722a4.964 4.964 0 0 1 1.5.684A9.561 9.561 0 0 0 13.993 5z" fill="white" data-original="#000000" class=""></path></g></g></svg>
...
{{--            @endif--}}
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->path() === 'user/notifications') active @endif " href="/user/package">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="feather feather-user">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                    ...
                    <span class="nav-link-text ms-3">الاشعارات</span>
                </a>
            </li>
            <li class="nav-item">
