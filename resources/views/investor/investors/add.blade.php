                        ...
                        <form action="/save-investor" method="post" class="multisteps-form__form mb-8">
                            ...
                            <div class="card card-body p-3  js-active" data-animation="FadeIn">
                                <h5 class="font-weight-bolder mb-0">
                                    @if (empty($investor)) {{ __('Add New Investor') }} @else {{ __('Edit Investor') }} @endif
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input name="first_name" class="multisteps-form__input form-control"
                                                type="text"
                                                @if (!empty($investor)) value="{{ $investor->first_name }}" @else value="{{ old('first_name') }}" @endif />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            ...
                                            <input name="last_name" class="multisteps-form__input form-control"
                                                type="text"
                                                @if (!empty($investor)) value="{{ $investor->last_name }}" @else value="{{ old('last_name') }}" @endif />
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            ...
                                            <input name="phone_number" class="multisteps-form__input form-control"
                                                value="{{ $investor->phone_number ?? (old('phone_number') ?? '') }}">
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>{{ __('Source') }}</label>
                                            <input name="source" class="multisteps-form__input form-control"
                                                value="{{ $investor->source ?? (old('source') ?? '') }}" />
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="Pending"
                                                        @if (($investor->status ?? null) === 'Pending') selected @endif
                                                        @if (old('status') === 'Pending') selected @endif>
                                                        {{ __('Pending') }}</option>
                                                    <option value="Approved"
                                                        @if (($investor->status ?? null) === 'Approved') selected @endif
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            ...
                                            <input name="twitter" class="multisteps-form__input form-control" type="text"
                                                @if (!empty($investor)) value="{{ $investor->twitter }}" @else value="{{ old('twitter') }}" @endif />
                                        </div>
                                        <div class="col-12 mt-3">
                                            ...
                                            <input name="facebook" class="multisteps-form__input form-control"
                                                type="text"
                                                @if (!empty($investor)) value="{{ $investor->facebook }}" @else value="{{ old('facebook') }}" @endif />
                                        </div>
                                        <div class="col-12 mt-3">
                                            <span>
                                            ...
                                            <input name="linkedin" class="multisteps-form__input form-control"
                                                @if (!empty($investor)) value="{{ $investor->linkedin }}" @else value="{{ old('linkedin') }}" @endif />
                                        </div>
                                    </div>
