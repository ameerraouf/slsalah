    ...
    <table class="table align-items-center mb-0" id="cloudonex_table">
        <thead>
            <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">{{__('Name')}}</th>
                ...
                <th class="text-secondary opacity-7">{{__('Procedures')}}</th>
            </tr>
        </thead>
        <tbody>
                    ...
                    <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">
                        <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center px-3">
                                <h6 class="mb-0 text-sm text-center"> {{$notice->title}} </h6>
                                <p class="text-xs text-secondary mb-0 text-center"></p>
                            </div>
                        </div>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                        <h6 class="mb-0  ">
                            @if($notice->status== 'Draft')
                                <span class="badge bg-pink-light text-danger mb-0">
                                    {{__('Draft')}}
                                </span>
                            @else
                    ...
                    <td class="align-middle text-center">
                        <div class="ms-auto">
                            <a class="btn btn-link text-danger text-gradient px-3 mb-0"
                                href="/delete/notice/{{$notice->id}}">
                                <i class="far fa-trash-alt me-2"></i>{{__('Delete')}}
                            </a>
                            <a class="btn btn-link text-dark px-3 mb-0" href="/write-notice/?id={{$notice->id}}">
                                <i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>{{__('Edit')}}
                            </a>
                        </div>
                    </td>
                </tr>
