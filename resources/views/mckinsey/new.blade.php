...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="font-weight-bolder"> {{ __(' McKinsey 7-S Model') }}</h4>
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="structure" name="structure">
@if (!empty($model))
{{ $model->structure }}
@else
{{ old('structure') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="strategy" name="strategy">
@if (!empty($model))
{{ $model->strategy }}
@else
{{ old('strategy') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="system" name="system">
@if (!empty($model))
{{ $model->system }}
@else
{{ old('system') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="style" name="style">
@if (!empty($model))
{{ $model->style }}
@else
{{ old('style') }}
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="staff" name="staff">
@if (!empty($model))
{{ $model->staff }}
@else
{{ old('staff') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="skill" name="skill">
@if (!empty($model))
{{ $model->skill }}
@else
{{ old('skill') }}
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-12 align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="shared" name="shared_values">
@if (!empty($model))
{{ $model->shared_values }}
@else
{{ old('shared_values') }}
