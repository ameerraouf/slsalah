                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="political" name="political">
@if (!empty($model))
{{ $model->political }}
@else
{{ old('political') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="social" name="social">
@if (!empty($model))
{{ $model->social }}
@else
{{ old('social') }}
@endif
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="technological" name="technological">
@if (!empty($model))
{{ $model->technological }}
@else
{{ old('technological') }}
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col align-self-center">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-4" rows="10" id="legal" name="legal">
@if (!empty($model))
{{ $model->legal }}
@else
{{ old('legal') }}
                            ...
                            <div class="col align-self-end">
                                <div class="col align-self-center">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-4" rows="10" id="environmental" name="environmental">
@if (!empty($model))
{{ $model->environmental }}
@else
{{ old('environmental') }}
