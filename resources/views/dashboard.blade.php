    ...
    <div class="row mb-3">
        ...
        @if ($trial_will_expire)
            <div class="col text-end">
                <span class="badge bg-pink-light text-danger">{{ __('Trial Expiring in') }}
                    {{ $trial_will_expire->diffForHumans() }}</span>
        ...
        <div class="col-md-6">
            <div class="card bg-purple-light">
                <div class="card-body">
                    <div class="row">
                        <div class="">
                            <h4 class="fw-bolder">{{ __('Hello,') }}</h4>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    @if (!empty($recent_note->notes))
                                        ...
                                        <p>{{ __(' Read More') }}
                                            <i class="fas fa-arrow-right text-sm ms-1 mt-2" aria-hidden="true"></i>
                                        </p>
                                    @endif
                                    </a>
                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                    ...
                                                    @if (isset($users[$todo->contact_id]))
                                                        @if (!empty($users[$todo->contact_id]->photo))
                                                            <a href="javascript:" class="avatar avatar-sm rounded-circle"
                                                                ...
                                                                title="{{ $users[$todo->contact_id]->first_name }}">
                                                                <img
                                                                    src="{{ PUBLIC_DIR }}/uploads/{{ $users[$todo->contact_id]->photo }}">
                                                            </a>
                                                        @else
                                                            <div class="avatar  avatar-sm rounded-circle bg-indigo">
                                                                <p class=" mt-3 text-white text-uppercase">
                                                                    {{ $users[$todo->contact_id]->first_name[0] }}{{ $users[$todo->contact_id]->last_name[0] }}
                                                                </p>
                                                            </div>
                                                        @endif
                                                    @endif
                                                ...
                                                <div class="text-sm fw-bold mt-2 ms-3 ">
                                                    @if (isset($users[$todo->contact_id]))
                                                        {{ $users[$todo->contact_id]->first_name }}
                                                        {{ $users[$todo->contact_id]->last_name }}
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="avatar avatar-md me-3 bg-purple-light  border-radius-md p-2">
                                                    <h6 class="mt-2 text-purple">{{ $project->title['0'] }}</h6>
                                                </div>
                                                        ...
                                                        @if (isset($users[$member]))
                                                            ...
                                                            @else
                                                                <div
                                                                    ...
                                                                    <p class="mt-3 text-purple text-uppercase  ">
                                                ...
                                                <div class="dropstart">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3"
                                                        ...
                                                        <li><a class="dropdown-item border-radius-md"
                                                                href="/create-project?id={{ $project->id }}">{{ __('Edit') }}</a>
                                                        </li>
                                    ...
                                    @foreach ($recent_investors as $investor)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div
                                                        class="avatar avatar-md me-3 bg-purple-light  border-radius-md p-2">
                                                        <h6 class="mt-2 text-purple">
                                                ...
                                                <div>
                                                    <div class="dropstart">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3"
                                                            aria-labelledby="dropdownMarketingCard">
                                                            <li><a class="dropdown-item border-radius-md"
                                                                    href="/add-investor?id={{ $investor->id }}">{{ __('Edit') }}</a>
                                                            </li>
