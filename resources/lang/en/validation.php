...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'source_name'                  => 'اسم الإيراد الفرعي',
        'unit'                  => 'وحدة الإيراد الفرعي',
        'unit.*'                  => 'وحدة الإيراد الفرعي',
        'main_unit'                  => 'وحدة الإيراد',
        'unit_price'                  => 'سعر الايراد الفرعي',
        'unit_price.*'                  => 'سعر الايراد الفرعي',
        'main_unit_price'                  => 'سعر الايراد',
        'amount '                  => 'المبلغ',
        'investing_price'                  => 'التكلفة',
        'maximum_allowed_users'                  => 'الحد الأقصى للمستخدمين المسموح بهم',
        'price_yearly'                  => 'السعر الرئيسي سنوي',
        'offer_price_yearly'                  => 'سعر العرض سنوي',
        'price_monthly'                  => 'السعر الرئيسي شهري',
